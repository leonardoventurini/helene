...
describe('Binary search tree', function () {
  ...
  describe('Search', function () {
    ...
    it('Bounded search can handle cases where query contains both $lt and $lte, or both $gt and $gte', function () {
      ...
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 15, $lt: 15 }), [
        'data 8',
        'data 10',
        'data 13',
      ])
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 18, $lt: 15 }), [
        'data 8',
        'data 10',
        'data 13',
      ])
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 15, $lt: 18 }), [
        'data 8',
        'data 10',
        'data 13',
        'data 15',
